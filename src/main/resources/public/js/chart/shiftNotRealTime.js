var app = angular.module('shiftNotRealTime',['ui.bootstrap','avit.services','chartUtil.services']);
...
app.controller(
				...
				function($scope,$location,$http,$sce,$timeout,avitUtil,chartUtil) 
				{
					...
					$scope.channelDoCheck=function()
                	  ...
                	  {
                    		figureType=1;
                    		chartUtil.kibanaChartData($scope,$sce,flag,'shiftNotRealTimeChannelWatchCount');
                	  }; 
                    	  
                      	  $scope.channelUserCount=function(flag)
                    	  {
                      		figureType=2;
                      		chartUtil.kibanaChartData($scope,$sce,flag,'shiftNotRealTimeChannelUserCount');
                    	  };
