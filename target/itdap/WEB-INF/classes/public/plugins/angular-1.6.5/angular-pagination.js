...
var pageModel = angular.module('pageModel', []).directive('myPagination', function () 
{
  return {
    restrict: 'EA',
    replace: true,
    ...
    link: function ($scope) {
      ...
      $scope.setPageParams = function (data,currPage) {
...
pageModel.service('pageModelService', function(){
    	
	 this.setPageParams = function($scope,currPage,data) {
		   $scope.option = 
		  {
			    curr: currPage, 
			    all: data.totalElements, 
