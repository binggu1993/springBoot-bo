var app = angular.module('shiftRealTime',['ui.bootstrap','avit.services','chartUtil.services']);
...
app.controller(
				...
				function($scope,$location,$http,$sce,avitUtil,chartUtil) 
				{
                  	  ...
                  	  $scope.EpgWatchCount=function(flag)
                	  {
                  		...
                  		chartUtil.kibanaChartData($scope,$sce,flag,'shiftRealTimeEpgWatchCount');
                    	  ...
                    	  $scope.ChannelUserCount=function(flag)
                    	  {
                    		  figureType=4;
                    		  $scope.isShowPeriod=true;
                    		  chartUtil.kibanaChartData($scope,$sce,flag,'shiftRealTimeChannelUserCount');
                    	  };
